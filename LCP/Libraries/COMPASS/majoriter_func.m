function [ x_k, v_k, w_k, z_k, a_k, f_z_k, ...
...
%
% An adaptation of the majoriter.m file of Stefan Schmelzer, in the
...
while (stop == 0)
  ...
  %%%%%%%%%%%%%%%%%%%%
% minoriter
  % pivot routine solves Approx(x_k)=0 and generates path from x_k to x_k_N 
  % (or z_k to z_k_N).  
% Kuhn: change minoriter.m script to minoriter_func.m function
  [ minor_count, ...
...
% Kuhn: change NMS.m script to NMS_func.m function
    [ next_x_near, x_next, a_k, v_k, w_k, z_k, z_b, ...
