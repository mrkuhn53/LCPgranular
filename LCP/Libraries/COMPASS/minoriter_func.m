function [ minor_count, ...
           zwvt, a_k, v_k, w_k, z_k, z_b, ...
           x_k_N, v_k_N, w_k_N, z_k_N, ...
           checkpointxN, checkpointzN, in_pivot, ...
           no_solution_LCP_row, in_minoriter, search_type_change, ...
           abort, unsuccessful, take_pg_step, stop, restart, tgone_count] = ...
         minoriter_func( ...
           n, z_k, f, Df, l, u, a_k, x_k, v_k, w_k, ...
           f_z_k, major, Var, ...
           display_depth, no_solution_LCP_row, max_no_solution_LCP_row, ...
           checkpointxN, checkpointzN, ...
           max_minor, mark_check, in_minoriter, cyclesize, maybe_cycle, ...
           definitive_cycling, search_type_change, ...
           abort, unsuccessful, take_pg_step, stop, restart, tgone_count)
%
% An adaptation of the minoriter.m file of Stefan Schmelzer, in the
...
% Kuhn: change pivotinit.m script to pivotinit_func.m function
[ minor, t, j, z_b, a_k, v_k, w_k, z_rem, M_rem, zwvt, in_pivot, ...
...
pivotinit_func( ...
  n, z_k, l, u, ...
  a_k, x_k, v_k, w_k, ...
  M, q, r, in_pivot, up_down, [], no_move_count, ... % Kuhn: set j_old = []
...
% Kuhn: change pivotloop.m script to pivotloop_func.m function
[ minor, zwvt, j, z_b, M_rem, z_rem, Cover, t, remember_t, in_pivot, ...
  up_down, no_move_a_count, remember_a, remember_j, ...
  take_pg_step, direction, abort, unsuccessful] = ...
pivotloop_func( ...
  n, zwvt, j, z_b, l, u, minor, Var, in_pivot, ...
  a_k, v_k, w_k, z_k, t, ray, q, r, M, M_rem, z_rem, direction, ...
  M_b, Cover, take_pg_step, Ia, Iv, Iw, Basis, b_vec, H, up_down, ...
  cyclesize, maybe_cycle, max_minor, remember_a, remember_j, ...
  definitive_cycling, display_depth, ...
  no_move_count, no_move_a_count, abort, unsuccessful);
%%%%%%%%%%%%%%%%
