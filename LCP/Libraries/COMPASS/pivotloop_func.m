function [ minor, zwvt, j, z_b, M_rem, z_rem, Cover, t, remember_t,in_pivot, ...
...
%
% An adaptation of the pivotloop.m file of Stefan Schmelzer, in the
...
%     pivotupdate
% Kuhn: change pivotupdate.m script to pivotupdate_func.m function
      [ j, j_old, zwvt, b_vec, coeff, t, in_pivot, ...
        z_b, a_k, v_k, w_k, z_k, H, Basis, Var0, ...
        M_rem, z_rem, Ia, M_b, Cover, ...
        take_pg_step, display_min_vec_j, back_to_start, ...
        up_down, no_move_a_count, remember_a, remember_j, ...
        no_move_count, abort, unsuccessful] = ...
      pivotupdate_func( ...
        n, j, zwvt, l, u, ray, q, r, M, M_rem, z_rem, t, in_pivot, ...
        z_b, a_k, v_k, w_k, z_k, Var0, ...
        M_b, Ia, Iv, Iw, Basis, b_vec, H, up_down, minor, Var, ...
        take_pg_step, next, direction, Cover, ...
        no_move_count, no_move_a_count, remember_a, remember_j, ...
        abort, unsuccessful, display_depth);
